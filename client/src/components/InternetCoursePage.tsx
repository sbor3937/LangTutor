...
type Lesson = { lesson_key: string; title: string; position: number; content: { goal: string; minutes: number; explanation: string; practices: string[]; words: Word[] } };
